            ...
            <div className="w-full space-y-4 mx-3">
                <div className="container mx-auto px-4 py-6">
                    <div className="space-y-6">
                        <Card className="shadow-lg border-0">
                            <CardHeader className="bg-teal-600 text-white rounded-t-lg">
                                <CardTitle className="text-2xl font-semibold">Thông tin yêu cầu bảo lãnh</CardTitle>
                            </CardHeader>

                            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                                <div className="space-y-2">
                                    <Label htmlFor="organizationName" className="text-lg font-medium text-gray-700">Tên tổ chức:</Label>
                                    <Input id="organizationName" value={requestData.organizationName} readOnly className="h-12 text-lg bg-gray-50" />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="type" className="text-lg font-medium text-gray-700">Bên bảo lãnh:</Label>
                                    <Input id="type" value={guaranteeTypes.find(t => t.value === parseInt(requestData.type))?.label || 'Không xác định'} readOnly className="h-12 text-lg bg-gray-50" />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="organizationType" className="text-lg font-medium text-gray-700">Loại tổ chức:</Label>
                                    <Input id="organizationType" value={organizationTypes.find(t => t.value === parseInt(requestData.organizationType))?.label || 'Không xác định'} readOnly className="h-12 text-lg bg-gray-50" />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="position" className="text-lg font-medium text-gray-700">Chức vụ:</Label>
                                    <Input id="position" value={requestData.position} readOnly className="h-12 text-lg bg-gray-50" />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="bankAccountNumber" className="text-lg font-medium text-gray-700">Số tài khoản ngân hàng:</Label>
                                    <Input id="bankAccountNumber" value={requestData.bankAccountNumber} readOnly className="h-12 text-lg bg-gray-50" />
                                </div>
                        ...
                        <Card className="shadow-lg border-0">
                            ...
                            <CardContent className="p-6">
                                <div className="space-y-4">
                                    <div>
                                        <Label className="text-lg font-medium text-gray-700">Giấy phép hoạt động:</Label>
                                        <a href={requestData.licenseToOperate} target="_blank" rel="noopener noreferrer" className="ml-2 text-blue-600 hover:underline">
                                            Xem tài liệu
                                        </a>
                                    </div>
                                    <div>
                                        <Label className="text-lg font-medium text-gray-700">Kinh nghiệm tình nguyện:</Label>
                                        <a href={requestData.volunteerExperienceFiles} target="_blank" rel="noopener noreferrer" className="ml-2 text-blue-600 hover:underline">
                                            Xem tài liệu
                                        </a>
                                    </div>
                                </div>
